      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="text-center md:text-left">
            <img src="/image.png" alt="HOODLY" className="h-20 mb-4 rounded-lg shadow-xl hover:scale-105 transition-transform duration-300 border-2 border-cyan-400/30 mx-auto md:mx-0" />
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="text-gray-300 hover:text-cyan-400 transition-colors inline-flex items-center"><span className="mr-2">→</span> Home</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-cyan-400 transition-colors inline-flex items-center"><span className="mr-2">→</span> Contact</Link></li>
            </ul>
          </div>
