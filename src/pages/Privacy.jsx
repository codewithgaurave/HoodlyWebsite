      ...
      <div className="relative bg-slate-900 text-white py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <div className="inline-block mb-6">
            <span className="bg-cyan-500/20 text-cyan-400 px-6 py-2 rounded-full text-sm font-semibold border border-cyan-500/30">Privacy & Security</span>
          </div>
          <h1 className="text-6xl md:text-7xl font-bold mb-6">Privacy Policy</h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">Your privacy matters to us. Learn how we protect and handle your data with transparency and care.</p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
              <div className="text-cyan-400 text-4xl font-bold mb-2">🔒</div>
              <h3 className="text-lg font-semibold mb-1">Secure Data</h3>
              <p className="text-gray-400 text-sm">End-to-end encryption</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
              <div className="text-cyan-400 text-4xl font-bold mb-2">✓</div>
              <h3 className="text-lg font-semibold mb-1">GDPR Compliant</h3>
              <p className="text-gray-400 text-sm">Following global standards</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
              <div className="text-cyan-400 text-4xl font-bold mb-2">👤</div>
              <h3 className="text-lg font-semibold mb-1">Your Control</h3>
              <p className="text-gray-400 text-sm">Manage your data anytime</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-3">We implement appropriate technical and organizational measures to protect your personal information:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-3">We do not sell your personal information. We only share your information:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">We retain your information as long as your account is active or as needed to provide services. We may also retain and use your information as necessary to comply with legal obligations, resolve disputes, and enforce our agreements.</p>
            <p className="text-gray-700 leading-relaxed">When you request deletion of your account, we will delete or anonymize your personal information within 30 days, except where we are required to retain it for legal purposes.</p>
          </section>

          <section className="mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">7. Third-Party Services</h2>
            <p className="text-gray-700 mb-3 leading-relaxed">Our app integrates with trusted third-party services:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">We use cookies and similar tracking technologies to track activity on our service and hold certain information. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent.</p>
            <p className="text-gray-700 leading-relaxed">We use both session and persistent cookies for authentication, preferences, and analytics purposes. You can manage cookie preferences through your device settings.</p>
          </section>

          <section className="mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">9. Children's Privacy</h2>
            <p className="text-gray-700 leading-relaxed">Our service is not intended for children under 18 years of age. We do not knowingly collect personal information from children. If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately.</p>
          </section>

          <section className="mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">10. International Data Transfers</h2>
            <p className="text-gray-700 leading-relaxed">Your information may be transferred to and maintained on computers located outside of your state, province, country, or other governmental jurisdiction where data protection laws may differ. We ensure appropriate safeguards are in place to protect your data during such transfers.</p>
          </section>

          <section className="mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">11. Changes to Privacy Policy</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the last updated date.</p>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">If you have any questions about this Privacy Policy, please contact us:</p>
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 p-8 rounded-xl border border-cyan-200">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-bold text-gray-900 mb-3">Privacy Department</h4>
                  <p className="text-gray-700 mb-2"><strong>Email:</strong> privacy@myapp.com</p>
              ...
              <div className="mt-6 pt-6 border-t border-cyan-200">
                ...
                <p className="text-gray-600 text-sm mt-1">Version 1.0 - Compliant with Google Play Store policies and Indian IT Act 2000</p>
              </div>
            </div>
          </section>
        </div>
